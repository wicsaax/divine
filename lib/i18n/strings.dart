...
const Map<String, String> _zh = {
  ...
  'reading.manual_section': '起卦/抽牌方式',
  'reading.manual_self': '我自己抽',
  'reading.manual_random': '让 app 随机',
  'reading.manual_hint_self': '你已经在外面抽完牌/起完卦, 把结果填这里, app 只负责解读.',
  'reading.manual_hint_random': '由 app 随机抽; 抽完先看结果, 再决定要不要点解读.',
  'reading.manual_pick_prompt': '点击选择',
  'reading.manual_search': '搜索',
  'reading.manual_interpret': '让 AI 解读这次结果',
...
const Map<String, String> _en = {
  ...
  'reading.manual_section': 'How to draw',
  'reading.manual_self': 'I drew it',
  'reading.manual_random': 'App randomizes',
  'reading.manual_hint_self': 'You already drew the cards / cast the hexagram yourself. Fill in the result; the app will only interpret.',
  'reading.manual_hint_random': 'App will randomize for you. You see the result first, then decide whether to request AI interpretation.',
  'reading.manual_pick_prompt': 'Tap to pick',
  'reading.manual_search': 'Search',
  'reading.manual_interpret': 'Have AI interpret this',
