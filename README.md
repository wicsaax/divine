...
- [x] **塔罗牌面 + 翻牌动画** — 程序化绘制的牌面 + 翻转入场动画
- [x] **Android 前台服务保活网络**
- [x] **紫微斗数基础排盘** — 命/身宫, 五行局, 14 主星, 12 宫位. 六吉六煞与四化交给 LLM 推断
- [x] **占星 sweph 真算** — 十大行星黄经 + Placidus 宫位 + 主要相位

待做:
- [ ] **真实韦特塔罗牌面图片** — 替换当前程序化牌面. 需要找/制作 78 张公版图. 2-3 小时
- [ ] **紫微深化** — 六吉六煞 (左辅右弼天魁天钺文昌文曲擎羊陀罗火星铃星地空地劫) + 四化 (禄权科忌) + 大限 + 流年
- [ ] **占星深化** — 行运 (transits) 计算 + 推运 + 太阳弧 + 中点
