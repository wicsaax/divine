...
| 体系 | 实现 |
|---|---|
| 塔罗 🃏 | 真韦特公版图 78 张 + 4 种牌阵 + 翻转动画 + 正逆位 |
| 雷诺曼 🎴 | 36 张 emoji 牌面 + 三牌线 / 九宫格 |
| 周易六爻 ☯ | 三钱法 + 64 卦 + 动爻变卦 + 卦象六爻视觉化 |
| 梅花易数 🌸 | 邵雍数字起卦 + 体用变互 |
| 八字 🐉 | 真排盘 (lunar): 四柱 + 十神 + 大运 |
| 紫微斗数 ✶ | 完整排盘: 14 主星 + 六吉六煞 + 四化禄权科忌 + 12 大限 + 流年 + 当前大限/流年宫高亮 |
| 西洋占星 🪐 | sweph: 十行星 + Placidus 宫 + 相位 + 行运 + 推运 + 太阳弧 + 中点 + wheel 叠加可视化 |
| 印度占星 🕉 | sweph 恒星黄道 (Lahiri ayanamsa) Vedic 视角 |
| 数字命理 🔢 | 毕达哥拉斯生命数 + 大师数 + 光晕脉冲展示 |
| 卢恩符文 ᚱ | Elder Futhark 24 符 + 3 阵 + 石头质感卡 |
| Ogham 🌳 | 凯尔特树文字 20+5 + 木纹质感卡 |
| 玛雅卓尔金 🐆 | 260 日历: 20 日签 + 13 银河音, 出生印记 / 今日讯息 |
| 西方土占 ⛰️ | Geomancy 16 figures + 母女侄见证判官标准盘 |
| 解梦 💤 | 多视角: 荣格 / 弗洛伊德 / 东方 / 灵性 / 反复梦 / 噩梦 |
| 经典占卜 📖 | 圣经 / 道德经 / 论语 / 诗经 / 庄子 随机引段, 羊皮卷展开 |
| 是否占卜 ⚖️ | 塔罗 / 三硬币 / 魔法八号球, YES/NO 大字动画 |
| 通用 AI 占卜 🔮 | 4 种模式 + 水晶球动画 |
...
- [x] **占星可视化** — 行运 (外圈蓝)、推运 (内圈紫) 叠加到本命盘 wheel, 行运 → 本命的紧密相位虚线
- [x] **紫微大限/流年高亮** — 在 12 宫盘上根据当前年龄/年份, 当前大限宫橙边 + "限", 流年命宫绿边 + "年"
- [x] **手抽模式** — 9 种占卜 (塔罗/雷诺曼/六爻/梅花/卢恩/Ogham/土占/经典占卜/是否) 都可以"我自己抽好填进来", app 只负责 AI 解读
